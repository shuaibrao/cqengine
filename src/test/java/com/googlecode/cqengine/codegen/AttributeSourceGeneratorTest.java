...
public class AttributeSourceGeneratorTest {
    ...
    @Test
    public void generatedIdentifiersDoNotDependOnTheDefaultLocale() {
        Locale previousLocale = Locale.getDefault();
        try {
            Locale.setDefault(Locale.forLanguageTag("tr-TR"));
            String source = AttributeSourceGenerator.generateSimpleAttribute(
                    "Index", "String", "identifier", AttributeSourceGenerator.MemberType.FIELD);

            assertTrue(source.contains("Attribute<Index, String> IDENTIFIER"));
            assertTrue(source.contains("getValue(Index index, QueryOptions"));
            assertTrue(source.contains("return index.identifier;"));
        }
        finally {
