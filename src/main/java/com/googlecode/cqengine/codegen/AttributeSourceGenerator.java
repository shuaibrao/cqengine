...
public class AttributeSourceGenerator {
    ...
    static String generateSimpleAttribute(String objectType, String attributeType, String memberName, MemberType memberType) {
        return "    /**\n" +
                ...
                "        public " + attributeType + " getValue(" + objectType + " " + objectType.toLowerCase(Locale.ROOT) + ", QueryOptions queryOptions) { return " + objectType.toLowerCase(Locale.ROOT) + "." + memberName + memberType.accessSuffix + "; }\n" +
                "    };";
    }
    ...
    static String generateMultiValueNullableAttributeForIterable(String objectType, String attributeType, String memberName, MemberType memberType) {
        return "    /**\n" +
                ...
                "        public Iterable<" + attributeType + "> getNullableValues(" + objectType + " " + objectType.toLowerCase(Locale.ROOT) + ", QueryOptions queryOptions) { return " + objectType.toLowerCase(Locale.ROOT) + "." + memberName + memberType.accessSuffix + "; }\n" +
                "    };";
    }
    ...
    static String generateMultiValueNullableAttributeForObjectArray(String objectType, String attributeType, String memberName, MemberType memberType) {
        return "    /**\n" +
                ...
                "    //   MultiValueNullableAttribute with a MultiValueAttribute (and change getNullableValues() to getValues())\n" +
                "    public static final Attribute<" + objectType + ", " + attributeType + "> " + toUpperCaseWithUnderscores(memberName) + " = new MultiValueNullableAttribute<" + objectType + ", " + attributeType + ">(\"" + toUpperCaseWithUnderscores(memberName) + "\", true) {\n" +
                "        public Iterable<" + attributeType + "> getNullableValues(" + objectType + " " + objectType.toLowerCase(Locale.ROOT) + ", QueryOptions queryOptions) { return Arrays.asList(" + objectType.toLowerCase(Locale.ROOT) + "." + memberName + memberType.accessSuffix + "); }\n" +
                "    };";
    }
    ...
    static String generateMultiValueNullableAttributeForPrimitiveArray(String objectType, String attributeType, String primitiveType, String memberName, MemberType memberType) {
        return "    /**\n" +
                ...
                "        public Iterable<" + attributeType + "> getNullableValues(final " + objectType + " " + objectType.toLowerCase(Locale.ROOT) + ", QueryOptions queryOptions) {\n" +
                "            return new AbstractList<" + attributeType + ">() {\n" +
                "                public " + attributeType + " get(int i) { return " + objectType.toLowerCase(Locale.ROOT) + "." + memberName + memberType.accessSuffix + "[i]; }\n" +
                "                public int size() { return " + objectType.toLowerCase(Locale.ROOT) + "." + memberName + memberType.accessSuffix + ".length; }\n" +
                "            };\n" +
                "        }\n" +
                "    };";
    }
